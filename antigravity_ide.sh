...
TARBALL_URL=$(echo "$js_content" | grep -oE "https://edgedl\.me\.gvt1\.com/edgedl/release2/[0-9a-zA-Z]+/antigravity/stable/[0-9a-zA-Z.-]+/${ARCH_SUFFIX}/Antigravity%20IDE\.tar\.gz" | head -n 1)
